...
def parse_mappings_from_categories_page():
    """
    Parse Cognitive Atlas Categories' page to a dict {concept: category}
    """
...
def get_cogatlas_concepts():
    """
    Fetch all cogatlas concepts as dict
    """
...
def find_cogatlas_concept_by_name(name, cogatlas_concepts):
    """
    Search a specific cogatlas concepts in the dict of all cogatlas concepts
    """
